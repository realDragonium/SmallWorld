...
public class AnimationControler{
	...
	public void createAnimPoint(Translate pos, double rotX, double rotY, double rotZ, int time) {
    	controlers.AnimPointControler point = new controlers.AnimPointControler();
    ...
    public void confPosChange() {
    	controlers.AnimPointControler nextPoint = model.AnimPoints.get(model.nextAnimPoint);
    	controlers.AnimPointControler lastPoint = model.AnimPoints.get(model.nextAnimPoint - 1);
